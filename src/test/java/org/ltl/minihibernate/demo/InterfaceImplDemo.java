...
import org.ltl.minihibernate.internal.MiniEntityManagerImpl;
...
public class InterfaceImplDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\n=== Summary ===");
    System.out.println("You code against: org.ltl.minihibernate.api.* (interfaces)");
    System.out.println("Code executes in: org.ltl.minihibernate.internal.*(implementations)");
